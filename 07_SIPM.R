...
TM.seeds <- function(x, d, elas, seeds.per.fruit = 5){
  xb = pmin(pmax(x, LATR_size_bounds$min_size), LATR_size_bounds$max_size)
...
TM.fertrecruit <- function(x, y, d, elas){
