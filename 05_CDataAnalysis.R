...
# Pilot fits, where sigma depends on initial size only; constant sigma
...
# hist(log(LATR_surv_dat$volume_t[LATR_surv_dat$transplant == TRUE]), breaks = 10,
#      add = TRUE, col = alpha("gray", 0.5))
...
# Note: we assume 5 seeds per fruit
