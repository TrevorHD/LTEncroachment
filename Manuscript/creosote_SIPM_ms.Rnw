...
surv_aic<-xtable(aic_tables$surv_aic_out[,c("surv","df","dAIC")], caption = "AIC model selection of survival probability.", label = "tab:surv_aic",
                 hline.after=c(-1,0,1,2,3))
align(surv_aic)<-"c|p{8cm}|c|c|"
print(surv_aic, 
      include.rownames=F,
      include.colnames=T, 
