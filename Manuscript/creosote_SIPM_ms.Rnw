...
Ecological theory for invasion waves as described above provides a tool that can be used to better \tom{understand}{It is still not explicit from your writing what it is we need to understand about encroachment. This will be helpful to add.} and manage woody encroachment, \tom{with many sites of shrub expansion around the world providing opportunities to do so}{Very little information here.}.
\tom{One particular site of interest}{I think this is an awkward transition. Woudl be better to start a new paragraph with 'In this study, we...' and then jump into the SEV system. You can then go on to describe (as you do below) why this is a compelling system for questions about encroachment.} is the Chihuahuan Desert of the southwestern United States, where \tom{extensive documentation of shrub encroachment already exists}{This obscures the novel contribution of this study. I would rephrase this.}.
Here, populations of the creosotebush (\textit{Larrea tridentata}) have been expanding into nearby grasslands for approximately 150 years and have decreased the cover of grasses such as Bouteloua eriopoda \citep{gardner1951vegetation, buffington1965vegetational, gibbens2005vegetation}.
