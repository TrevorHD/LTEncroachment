...
The speed of encroachment at the study site as estimated by the SIPM is rather slow; as can be seen in Figure 1, the low-density wavefront moves at approximately 0.5 cm/yr under normal conditions and at 1 cm/yr under the best seedling survival conditions observed in the dataset.
...
For both scenarios, the decrease in population growth rate with increasing density was monotonic across the range of observed standardised densities, as is shown in Figure 1.
...
Thus, as Figure 2 demonstrates, shorter dispersal distances dominate; even for the tallest shrub, 81\% of seeds fall within only a metre of the plant, and this percentage increases as shrub height decreases.
...
This, along with size and density dependence in growth and reproduction, is shown in Figure 3.
