...
Lengths of these transects varied from 200 to 600 m, determined by the strength of vegetation transition, as ``steep'' transitions required less length to capture the full range of shrub densities. 

We quantified shrub density in 5-meter ``windows'' along each transect, including plants within one meter of the transect on either side.
...
In instances where shrubs had large numbers of reproductive structures that would be difficult to reliably count, we made counts on a fraction of the shrub and extrapolated to estimate whole-plant reproduction. 
