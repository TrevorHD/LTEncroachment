...
To our knowledge such switches have never been empirically documented in any expanding population but are ripe for future study. 

The very low transplant survival and recruitment rates that we measured also relates to the issue of time scale. 
Previous studies suggest that creosote recruitment is strongly episodic in response to large, infrequent monsoon precipitation events \citep{moreno2016seed}.
...
While not as strong a constraint as recruitment, limited dispersal ability also contributed to the very slow speed of encroachment. 
Our mechanistic dispersal modeling was assumes that wind is the sole dispersal vector. 
...
Add biotic dispersal vectors.

Grass competition paragraph. 
