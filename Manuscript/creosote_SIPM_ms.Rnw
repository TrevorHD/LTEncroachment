...
\begin{enumerate}
\item What is the nature of conspecific density dependence in demographic vital rates along shrub encroachment ecotones? Is encroachment pulled by the individuals at the front of the wave or pushed by individuals behind it?
...
\item How does the observed rate of encroachment in recent past compare to model predictions?
