...
\comment{I strongly suggest the authors to re-frame completely the idea and focus it on which are the population dynamics mechanisms of shrublands in quasy-steady state. This is not going to change a lot the relevance and interest of their results, but I think it prevents almost completely the framing into the field of shrub encroachment (maybe dynamics post equilibria of shrub encroachment may make more sense?). As is, the paper is very misleading and leaves the reader a bit flat.}
\response{}
