...
Theory predicts that \revise{whether the wave can advance and the speed at which it does so} depends on two processes: local demography and dispersal of propagules.
...
\revise{\linelabel{siteinfo}SNWR has been closed to cattle grazing since 1973.
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\linewidth]{Manuscript/Figures/WavesPicsRevise}
    \caption{}
  \label{fig:waves}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\linewidth]{Manuscript/Figures/TransectResurveys}
  \caption{}
  \label{fig:resurvey}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\linewidth]{Manuscript/Figures/VitalRates}
  \caption{}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\linewidth]{Manuscript/Figures/LambdaDensity}
  \caption{}
  \label{fig:lambda}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\linewidth]{Manuscript/Figures/DispersalKernels}
  \caption{}
  \label{fig:dispersal}
  \end{center}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\linewidth]{Manuscript/Figures/WavespeedSens}
  \caption{}
  \label{fig:wavespeed}
  \end{center}
\end{figure}
